...
// Recursive case:
// 1. Destructure the array into the first element (first) and the
//    rest of the elements (rest).
// 2. Recursively call the function on the rest of the array.
// 3. Return the sum of the first element and the result of the
...
// 5. first = 5, rest = [], returns 5 + getSum([])
// Base case reached, returns 0
// Calculation during unwinding phase:
